...
// Pick top-rated, verified vendors across different categories
const topVendors = sampleVendors
  .filter((v) => v.verified && v.rating >= 4.7)
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="pt-3 border-t border-gray-50">
                    <button className="w-full px-4 py-2.5 text-sm font-semibold text-white rounded-xl bg-gradient-to-r from-shaadi-red to-shaadi-rose hover:from-shaadi-deep hover:to-shaadi-red transition-all">
                      Send Enquiry
                    </button>
                  </div>
                </div>
