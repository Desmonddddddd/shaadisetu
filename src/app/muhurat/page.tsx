...
export const metadata = {
  title: "Muhurat — Kundli matching & auspicious dates | ShaadiSetu",
  description:
    "Vedic kundli matching and curated auspicious wedding dates. Computed traditionally, explained in plain English.",
};
...
const features = [
  ...
  },
  {
    ...
    italic: "Picked from the Panchang.",
    blurb:
      "Curated shubh muhurat dates for vivah, sagai, and griha pravesh across 2026 and 2027. Every date listed with its tithi, nakshatra, and paksha.",
    cover:
      "https://images.unsplash.com/photo-1522413452208-996ff3f3e740?w=1600&q=80",
  },
];

export default function MuhuratHubPage() {
  return (
      ...
      <section className="relative border-b border-ink/10 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 py-20 md:py-28 text-center">
          ...
          <p className="fade-up stagger-2 mt-6 text-cream/80 max-w-2xl mx-auto leading-relaxed font-light text-base md:text-lg">
            Two traditional Vedic services, modernised. Match compatibility
            between two birth charts, or browse curated auspicious dates from
            the Panchang. Honest interpretation, no fearmongering.
          </p>
        </div>
      </section>
