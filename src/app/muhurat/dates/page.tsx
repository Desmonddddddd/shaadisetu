      ...
      <section className="relative border-b border-ink/10 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 py-16 md:py-24 text-center">
          ...
          <div className="fade-up stagger-3 mt-7 flex items-center justify-center gap-3 text-[0.7rem] uppercase tracking-[0.22em]">
            <Link href="/muhurat/match" className="text-cream/90 hover:text-champagne transition-colors">
              Match Kundlis →
            </Link>
            <span className="text-cream/30">·</span>
            <Link href="/muhurat/reading" className="text-cream/90 hover:text-champagne transition-colors">
              Read your chart →
            </Link>
          </div>
        </div>
